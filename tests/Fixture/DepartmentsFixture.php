...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dept_desc' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'dept_desc' => 1,
            'created_date' => '2016-03-17 18:47:34',
            'modified_date' => '2016-03-17 18:47:34'
        ],
    ];
}
