...
class ManufacturersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'manufacturer_desc' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'manufacturer_desc' => 'Lorem ipsum dolor sit amet',
            'created_date' => '2016-03-17 18:45:55',
            'modified_date' => 1458240355
        ],
    ];
}
